...
function convertNamespace(context, symbol, nameOverride) {
    ...
    if (((_a = symbol.getDeclarations()) === null || _a === void 0 ? void 0 : _a.some(ts.isModuleDeclaration)) !== true) {
    ...
    convertSymbols(context.withScope(reflection), getSymbolExportsWithFlag(symbol, exportFlags));
}
function convertTypeAlias(context, symbol, nameOverride) {
    ...
    if (ts.isTypeAliasDeclaration(declaration)) {
        ...
        jsdoc_1.convertJsDocAlias(context, symbol, declaration, nameOverride);
    }
    else {
...
function convertFunctionOrMethod(context, symbol, nameOverride) {
    ...
    const reflection = context.createDeclarationReflection(context.scope.kindOf(models_1.ReflectionKind.ClassOrInterface |
        ...
        : models_1.ReflectionKind.Function, symbol, nameOverride);
...
function convertProperty(context, symbol, nameOverride) {
    ...
    const reflection = context.createDeclarationReflection(context.scope.kindOf(models_1.ReflectionKind.Namespace)
        ...
        : models_1.ReflectionKind.Property, symbol, nameOverride);
...
function convertArrowAsMethod(context, symbol, arrow, nameOverride) {
    ...
    setModifiers(arrow.parent, reflection);
...
function convertVariableAsFunction(context, symbol, nameOverride) {
    ...
    setModifiers(declaration !== null && declaration !== void 0 ? declaration : symbol.valueDeclaration, reflection);
    // Does anyone care about this? I doubt it...
    if (declaration &&
        enum_1.hasAllFlags(symbol.flags, ts.SymbolFlags.BlockScopedVariable)) {
...
function setModifiers(declaration, reflection) {
    ...
    reflection.setFlag(models_1.ReflectionFlag.Readonly, enum_1.hasAllFlags(modifiers, ts.ModifierFlags.Readonly));
