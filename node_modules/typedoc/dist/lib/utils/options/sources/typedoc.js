...
const shiki_themes_1 = require("shiki-themes");
function addTypeDocOptions(options) {
    ...
    options.addDeclaration({
        ...
        validate: (value) => {
            if (!shiki_themes_1.BUNDLED_THEMES.includes(value)) {
                throw new Error(`Highlight Theme must be one of the following: ${shiki_themes_1.BUNDLED_THEMES.join(", ")}`);
            }
        },
    });
}
