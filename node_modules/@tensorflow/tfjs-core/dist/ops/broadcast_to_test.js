    ...
    it('[] -> [3,2]', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    a = tf.scalar(4.2);
                    A = tf.tensor2d([[4.2, 4.2], [4.2, 4.2], [4.2, 4.2]]);
                ...
                case 2:
                    ...
                    w = tf.tensor2d([[4.7, 4.5], [-6.1, -6.6], [-8.1, -3.4]]), f = function (a) {
                        return tf.broadcastTo(a, A.shape).mul(w).mean().asScalar();
                    }, h = function (a) { return a.mul(w).mean().asScalar(); };
...
//# sourceMappingURL=broadcast_to_test.js.map