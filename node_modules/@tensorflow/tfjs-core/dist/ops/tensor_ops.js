...
function onesLike_(x) {
    ...
    return engine_1.ENGINE.runKernelFunc(function (backend) { return backend.onesLike($x); }, { x: $x }, der, 'OnesLike');
}
/**
...
function zerosLike_(x) {
    ...
    var der = function (dy, saved) { return ({ x: function () { return exports.zerosLike(dy); } }); };
    return engine_1.ENGINE.runKernelFunc(function (backend) { return backend.zerosLike($x); }, { x: $x }, der, 'ZerosLike');
}
/**
