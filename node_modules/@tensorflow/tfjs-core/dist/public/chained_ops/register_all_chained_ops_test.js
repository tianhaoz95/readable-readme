...
var CHAINED_OPS = [
    ...
    'square', 'tile', 'transpose'
];
jasmine_util_1.describeWithFlags('chained ops', jasmine_util_1.ALL_ENVS, function () {
    it('all chained ops should exist on tensor ', function () { return __awaiter(_this, void 0, void 0, function () {
        var tensor, _i, CHAINED_OPS_1, opName;
        return __generator(this, function (_a) {
            tensor = tf.tensor([1, 2, 3]);
            for (_i = 0, CHAINED_OPS_1 = CHAINED_OPS; _i < CHAINED_OPS_1.length; _i++) {
                opName = CHAINED_OPS_1[_i];
                //@ts-ignore
