...
var proxyBackendName = 'test-async-cpu';
...
globals_1.registerBackend(proxyBackendName, function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
...
var kernels = kernel_registry_1.getKernelsForBackend('cpu');
kernels.forEach(function (_a) {
    var kernelName = _a.kernelName, kernelFunc = _a.kernelFunc, setupFunc = _a.setupFunc;
    kernel_registry_1.registerKernel({ kernelName: kernelName, backendName: proxyBackendName, kernelFunc: kernelFunc, setupFunc: setupFunc });
});
