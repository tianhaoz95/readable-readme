...
jasmine_util_1.describeWithFlags('PlatformNode', jasmine_util_1.NODE_ENVS, function () {
    it('fetch should use global.fetch if defined', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    globalFetch = tf.env().global.fetch;
                    spyOn(tf.env().global, 'fetch').and.returnValue(function () { });
    ...
    it('fetch should use node-fetch with tf.env().global.fetch is null', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    platform = new platform_node_1.PlatformNode();
                    savedFetch = platform_node.getSystemFetch();
